...
import { getCart, getProductById, getLoyaltyWallet, placeOrderFromCart, getEsewaSignature, initiateKhaltiPayment, quoteLoyaltyRedemption, validatePromoCode, getAddresses } from '../../customer/api/customerApi';
