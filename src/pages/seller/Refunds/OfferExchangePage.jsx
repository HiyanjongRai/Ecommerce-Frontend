    ...
    <div className={`p-5 border rounded-2xl space-y-4 ${
      ...
      <div className="flex items-start gap-3 text-xs">
        ...
        <div className="space-y-1">
          ...
          <p className="text-[10px] text-gray-400 font-semibold leading-relaxed">
            Please prepare the replacement item. Once shipped, click 'Confirm Completion' to enter courier tracking details and complete the case.
          </p>
        </div>
      </div>
      ...
      {detail.status === 'REPLACEMENT_PREPARING' && (
        <div className="pt-2">
          ...
          >
            Submit Shipment Courier & Tracking
          </button>
        </div>
      )}
    </div>
