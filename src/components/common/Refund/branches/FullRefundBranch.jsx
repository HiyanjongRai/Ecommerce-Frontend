...
import RequestRefundPage from '../../../../pages/customer/Refunds/RequestRefundPage';
import PaymentDetailsPage from '../../../../pages/customer/Refunds/PaymentDetailsPage';
import RefundCompletedPage from '../../../../pages/customer/Refunds/RefundCompletedPage';
import ReviewRequestPage from '../../../../pages/seller/Refunds/ReviewRequestPage';
import RequestPaymentDetailsPage from '../../../../pages/seller/Refunds/RequestPaymentDetailsPage';
import OfferFullRefundPage from '../../../../pages/seller/Refunds/OfferFullRefundPage';
import InspectProductPage from '../../../../pages/seller/Refunds/InspectProductPage';
import { Clock } from 'lucide-react';

export default function FullRefundBranch({
  actorRole,
  detail,
  onRefresh,
  setActionError,
  ...
  if (['REQUEST_CREATED', 'UNDER_REVIEW'].includes(detail.status)) {
    return (
      <ReviewRequestPage
        detail={detail}
        hooksContext={hooksContext}
