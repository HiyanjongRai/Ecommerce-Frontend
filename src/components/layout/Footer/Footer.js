...
export default function Footer({ isVerdant = false }) {
  ...
  return (
    <footer className="bg-neutral-900 text-gray-400 text-xs mt-16">
      ...
      {/* FOOTER MAIN CONTENT G현 4 columns with generous vertical spacing */}
      <div className="max-w-[1440px] mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-16">
        ...
        <div className="flex flex-col gap-5">
          ...
          <p className="leading-relaxed text-gray-400">
            {isVerdant 
              ...
              : "Nepal's trusted marketplace for electronics, fashion, and lifestyle products. Every listing is verified G현 shop with confidence, delivered to your door."
            }
          </p>
          ...
          <ul className="flex flex-col gap-4">
            ...
            <li className="flex items-start gap-3">
              ...
              <div>
                ...
                <p>Mon G혀 Sun / 9:00 AM G혀 8:00 PM</p>
              </div>
            </li>
          </ul>
        </div>
        ...
        {/* COLUMN 4: POPULAR TAGS G현 electronics/lifestyle relevant */}
        <div className="flex flex-col gap-5">
          <h4 className="text-white font-extrabold uppercase tracking-wider text-sm pb-2 border-b border-gray-800">
            Popular Tags
          </h4>
