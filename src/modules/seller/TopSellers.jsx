    ...
    <div className="min-h-screen bg-[#fafaf9] font-sans text-slate-800">
      ...
      <div className="relative overflow-hidden bg-gradient-to-r from-slate-900 to-slate-950 text-white py-16 px-6 shadow-md">
        ...
        <div className="max-w-[1400px] mx-auto relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-8">
          <div>
            <div className="inline-flex items-center gap-2 px-3 py-1 bg-emerald-500/20 border border-emerald-500/30 rounded-full text-xs font-black uppercase tracking-wider text-emerald-400 mb-3">
      ...
      <main className="max-w-[1400px] mx-auto px-4 py-10">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 mb-10 bg-white border border-gray-200 rounded-2xl p-4 shadow-sm">
          ...
          <div className="relative w-full md:w-96">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all"
            />
          </div>
        </div>
        ...
        {loading ? (
          <div className="flex flex-col items-center justify-center py-24">
            <svg className="animate-spin w-10 h-10 text-emerald-600 mb-4" fill="none" viewBox="0 0 24 24">
          ...
          <div className="flex flex-col items-center justify-center py-20 bg-white border border-gray-200 rounded-3xl text-center px-4 shadow-sm">
            ...
            <button
              ...
              className="px-5 py-2.5 bg-emerald-600 text-white hover:bg-emerald-700 rounded-xl font-bold transition-all text-xs"
            >
              Reset Search
            </button>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredSellers.map((seller, index) => {
              ...
              return (
                ...
                >
                  {/* Rank Badge */}
                  <span className="absolute top-4 right-4 flex items-center justify-center w-8 h-8 rounded-full text-xs font-black bg-gray-100 text-gray-500 group-hover:bg-emerald-50 group-hover:text-emerald-600 transition-colors">
                    #{rank}
                  </span>
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-4 mb-5">
                      ...
                      <div className="min-w-0">
                        <h3 className="font-bold text-base text-slate-800 truncate leading-tight group-hover:text-emerald-600 transition-colors">
                  ...
                  <Link
                    ...
                    className="w-full py-2.5 border border-emerald-600/50 text-emerald-600 hover:bg-emerald-600 hover:text-white text-xs font-black uppercase tracking-wider rounded-xl text-center transition-colors duration-250 flex items-center justify-center gap-1.5 focus:ring-2 focus:ring-emerald-500/20 outline-none"
                  >
