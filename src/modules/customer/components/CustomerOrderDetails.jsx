              ...
              <div className="flex items-center gap-3.5">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 font-medium">
                    Not satisfied with your order? You can return items within 7 days.
                  </p>
                </div>
              </div>
              <button
                onClick={() => setRefundModalOpen(true)}
                className="flex-shrink-0 text-[#16A34A] font-bold text-xs hover:underline cursor-pointer whitespace-nowrap"
              >
                Start a Return →
              </button>
            </div>
